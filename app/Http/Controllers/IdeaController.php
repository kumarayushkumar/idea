...
class IdeaController extends Controller
{
     ...
     */
    public function store(IdeaRequest $request, CreateIdea $createIdea): \Illuminate\Http\RedirectResponse
    {
     ...
     */
    public function update(IdeaRequest $request, Idea $idea, UpdateIdea $updateIdea): \Illuminate\Http\RedirectResponse
    {
        Gate::authorize('workWith', $idea);
